...
let d1 = "How are you Have you eaten yet?";
...
console.log("d1Tokens: ", d1Tokens);

let d2Tokens = nlp.tokenize(d2)
console.log("d2Tokens: ", d2Tokens);
...
console.log("cosineSim:",cosineSim1,cosineSim2)
